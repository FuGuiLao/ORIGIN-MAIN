    ...
    <div className="bg-zinc-800 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-base leading-7 sm:grid-cols-2 sm:gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-4">
          <div>
            <h3 className="border-l border-indigo-600 pl-6 font-semibold text-zinc-100">Los Angeles</h3>
            <address className="border-l border-gray-200 pt-2 pl-6 not-italic text-zinc-50">
          ...
          <div>
            <h3 className="border-l border-indigo-600 pl-6 font-semibold text-gray-100">New York</h3>
            <address className="border-l border-gray-200 pt-2 pl-6 not-italic text-zinc-50">
          ...
          <div>
            <h3 className="border-l border-indigo-600 pl-6 font-semibold text-zinc-100">Washington DC</h3>
            <address className="border-l border-gray-200 pl-6 pt-2 not-italic text-zinc-50">
