                                                       ...
                                                       <div className="fixed inset-0 overflow-hidden">
                                                           <div className="absolute inset-0  overflow-hidden">
                                                               <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10 sm:pl-16">
                                                                   ...
                                                                   >
                                                                       <Dialog.Panel className="pointer-events-auto w-screen content-end self-end max-w-2xl">
                                                                           <div className="flex h-2/3  flex-col bottom-0   place-items-end place-self-end overflow-y-scroll bg-white py-6 shadow-xl">
