...
export function FreeChapters() {
  return (
    <section
      ...
      className="scroll-mt-14 bg-gray-800 sm:scroll-mt-32"
    >
      <div className="overflow-hidden lg:relative">
        ...
        >
          <Pattern fill="#000" className="absolute -top-32 left-0 w-full sm:left-3/4 sm:-top-5 sm:ml-8 sm:w-auto md:left-2/3 lg:left-auto lg:right-2 lg:ml-0 xl:right-auto xl:left-2/3" />
          <div>
