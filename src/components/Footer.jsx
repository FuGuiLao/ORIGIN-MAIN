  ...
  return (
    <footer className="relative pt-5 pb-20 sm:pb-32 sm:pt-14">
      ...
      <div className="relative text-center text-sm text-zinc-600">
        ...
        <p><a href="/src/pages/terms-of-use.pdf" target="_blank">Terms of Use</a> | <a href="pages/privacy-policy.pdf" target="_blank">Privacy Policy</a> | <a href="data-security.pdf" target="_blank">Data Security</a>
        </p>
      </div>
    </footer>
  )
