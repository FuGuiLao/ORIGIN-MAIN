    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl pt-16 sm:px-6">
        <div className="bg-zinc-50 pt-px sm:rounded-6xl">
          <div className="relative mx-auto -mt-16 h-44 w-44 overflow-hidden rounded-full bg-zinc-300 md:float-right md:h-164 md:w-164 md:[shape-outside:circle(40%)] lg:mr-20 lg:h-72 lg:w-72">
            <Image
          ...
          <div className="px-4 py-10 sm:px-10 sm:py-16 md:py-20 lg:px-20 lg:py-32">
            ...
            <p className="mt-8 font-display text-5xl font-extrabold tracking-tight text-zinc-900 sm:text-6xl">
              <span className="block text-red-800">Jayden Brant –</span> <bold>The founder and managing partner of Origin</bold>
            </p>
