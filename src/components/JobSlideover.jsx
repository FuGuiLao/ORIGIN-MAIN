                  ...
                  <div className="flex h-full flex-col bg-white py-6 border border-zinc-50 shadow-sm">
                    ...
                    <div className="relative flex-1 overflow-y-auto px-4 sm:px-6">
                      ...
                      <p className="mt-0 mb-0 text-2xl tracking-tight text-zinc-900 font-bold px-10 py-4">Join us at Origin and be a part of a dynamic team that values excellence, innovation, and collaboration.</p>
                        <p className="mt-0 mb-10 text-2xl tracking-tight text-red-800 font-bold px-10 py-1"><a href="https://jobs.gusto.com/boards/origin-careers-e5e7c0e6-d25a-4784-9966-aad2669ee730" target="_blank">Please click here to get started.</a></p>
                    </div>
                  </div>
                </Dialog.Panel>
              </Transition.Child>
