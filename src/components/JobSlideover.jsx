                ...
                <Dialog.Panel className="pointer-events-auto w-screen max-w-2xl">
                  <div className="flex h-full flex-col bg-white py-6 border border-zinc-50 shadow-sm">
                    ...
                    <div className="relative flex-1 overflow-y-auto px-4 sm:px-6">
                      ...
                      <p className="mt-0 mb-0 text-sm tracking-tight text-zinc-700 px-10 py-1"><b>Interviews:</b> Selected candidates will participate in a series of interviews, including through Microsoft Teams and in-person meetings with team members and leadership.</p>
