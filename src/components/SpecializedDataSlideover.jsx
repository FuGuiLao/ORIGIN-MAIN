...
const SpecializedDataSlideover = ({ open, onClose }) => {
  return (
            ...
            <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10 sm:pl-16">
              ...
              >
                <Dialog.Panel className="pointer-events-auto w-screen max-w-2xl">
                  <div className="flex h-full flex-col overflow-y-hidden border border-zinc-50 bg-white py-6 shadow-sm">
...
export default SpecializedDataSlideover
