...
import seal_federalcourt from '@/images/seal_federalcourt2.png'
      ...
      <Expandable>
        {({ isExpanded }) => (
          <>
            ...
            {isExpanded && (
              <p className="text-sm tracking-tight text-zinc-600 text-center italic mt-8">While we maintain strict confidentiality, these are real testimonials from real clients.</p>
            )}
          </>
        )}
      </Expandable>
