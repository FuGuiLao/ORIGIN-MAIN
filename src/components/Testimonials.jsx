...
export function Testimonials() {
  return (
    <section className="py-8 sm:py-10 lg:py-16">
     ...
     <div className="mx-auto mt-8 mb-8 grid max-w-lg grid-cols-4 items-center gap-x-7 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
          <img
